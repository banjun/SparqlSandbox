...
open class SparqlParser: Parser {
	...
	static let RULE_query = 0, RULE_prologue = 1, RULE_baseDecl = 2, RULE_prefixDecl = 3, 
            ...
            RULE_varOrIRIref = 42, RULE_var_ = 43, RULE_graphTerm = 44, 
	...
	public class SelectQueryContext: ParserRuleContext {
			...
			open
			func var_() -> [Var_Context] {
				return getRuleContexts(Var_Context.self)
			}
			open
			func var_(_ i: Int) -> Var_Context? {
				return getRuleContext(Var_Context.self, i)
			}
		override open
		func getRuleIndex() -> Int {
	...
	public class OrderConditionContext: ParserRuleContext {
			...
			open
			func var_() -> Var_Context? {
				return getRuleContext(Var_Context.self, 0)
			}
		override open
		func getRuleIndex() -> Int {
	...
	public class Var_Context: ParserRuleContext {
			open
	...
	@discardableResult
	 open func var_() throws -> Var_Context {
		var _localctx: Var_Context = Var_Context(_ctx, getState())
		try enterRule(_localctx, 86, SparqlParser.RULE_var_)
		var _la: Int = 0
		defer {
	    		try! exitRule()
	    }
