...
open class SparqlLexer: Lexer {
	...
	static let T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, T__6=7, T__7=8, 
            ...
            T__57=58, IRI_REF=59, PNAME_NS=60, PNAME_LN=61, BLANK_NODE_LABEL=62, 
	...
	override open
	func getRuleNames() -> [String] { return SparqlLexer.ruleNames }

	override open
	func getSerializedATN() -> String { return SparqlLexer._serializedATN }

	override open
	func getChannelNames() -> [String] { return SparqlLexer.channelNames }

	override open
	func getModeNames() -> [String] { return SparqlLexer.modeNames }

	override open
	func getATN() -> ATN { return SparqlLexer._ATN }


	public
	static let _serializedATN: String = SparqlLexerATN().jsonString
